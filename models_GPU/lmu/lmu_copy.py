...
class LMUCell(Layer):
    ...
    def build(self, input_shape):
        ...
        self.memory_encoders = self.add_weight(
            ...
            shape=(self.order * self.input_dim, self.input_dim),
        ...
        self.memory_kernel = self.add_weight(
            name='memory_kernel',
            shape=(self.order * self.input_dim, self.units),
...
class LMUCellODE(Layer):
    ...
    def __init__(self,
        ...
        self.dt_initializer = initializers.get(Constant(1.))
        ...
        if not (self.trainable_dt or self.trainable_A or self.trainable_B):
            ...
            ss = cont2discrete(self._ss, dt=1., method=self.method)
...
class LMUCellGating(Layer):
    ...
    def __init__(self,
        ...
        self.forget_input_kernel_initializer = initializers.get(forget_input_kernel_initializer)
        self.forget_hidden_kernel_initializer = initializers.get(forget_hidden_kernel_initializer)
